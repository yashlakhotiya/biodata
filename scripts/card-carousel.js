// Card Animation Carousel Implementation
// Based on: https://codepen.io/blacklead-studio/pen/xbwaqxE
...
class CardStreamController {
  ...
  init() {
    // Wait for profile component to be loaded
  ...
  createCardWrapper(index) {
    ...
    // Use photoUrls array from assets/profilePictures.js
    const cardImages = window.photoUrls || [
    ...
    // Debug: Log which images are being used
    console.log('Card carousel using images:', cardImages.length > 5 ? 'photoUrls array' : 'fallback URLs');
    console.log('First image URL:', cardImages[0]);
...
class ParticleScanner {
  constructor() {
    ...
    this.initCanvas = () => {
      ...
      // Initialize context after canvas is available
...
// Initialize when DOM is ready and profile component is loaded
